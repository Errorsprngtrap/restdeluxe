...
- [x] Bonerush :  send a rush of different color bone
...
- [x] Bomb : spawn 5 bomb from the sky that will fal 
	mode 1 : just classic random bomb
	mode 2 : you manually place bomb that explode in x shape instead of the usual + shape 

Potion : you can create a potion
	freeze : freeze your opponent for 3 sec
	corrosion : quick 1 damage liquid 
	SpeedBoost : sans drink the potion and get +2 speed for 8 sec
	StamBoost : your maxstam increase by 10 + 15 normal stam
	 
- [x] Laser: laser come from the walls and move to the otherside 
